...
//	}
	...
	public void setDescricao(String descricao) {
		if(descricao == null || descricao.trim().equals("")) {
			throw new NullPointerException("A Descrição deve ter um conteúdo valido: ");
		}
	...
	public void setCh(int ch) throws IllegalAccessException {
		if(ch <= 0) {
			throw new IllegalAccessException("A carga horaria deve ser positiva");
		}
	...
	public void setPreco(double preco) throws InstantiationException {
		if(preco < 0) {
			throw new InstantiationException(" O preço não pode ser negativo");
		}
		this.preco = preco;
	}
